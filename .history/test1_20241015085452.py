...
driver = (
    webdriver.Chrome()
)  # 启动Chrome驱动，这里为Linux系统，Windows 和 Mac OS 根据实际路径填写
...
# kirhokyccya@mail.ru:J3mTTsxmUi?:kirhokyccya@mail.ru:J3mTTsxmUi?:linkedin.com/in/elizaveta-tarasova-3143a3330（叶飞测试）
